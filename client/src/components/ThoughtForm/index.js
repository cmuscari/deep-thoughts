...
const ThoughtForm = () => {
    ...
    // This function calls the addThought() mutation, so we'll define it as an async function ahead of time. It also clears the form values when the form is submitted.
